...
/**
 *
 * @author dberm22 (https://github.com/dberm22)
 */
public class JImagePanel extends JPanel implements Cloneable {
    ...
    private Position position = Position.STRETCH;
    ...
    public JImagePanel(String img, Color bgColor) {
        setBackground(bgColor);
        setBackgroundImage(img);
    }

    public JImagePanel(Image img, Color bgColor) {
        setBackground(bgColor);
        setBackgroundImage(img);
    }
    ...
    public JImagePanel clone() {
        try {
            return (JImagePanel) super.clone();
